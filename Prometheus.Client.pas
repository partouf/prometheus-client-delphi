...
type
  ...
  TPrometheusClientCounter = class(TInterfacedObject, IPrometheusCounter)
  private
...
begin
  Result := TPrometheusClientCounter.Create(MetricName, HelpText, LabelNames);
end;

{ TPrometheusClientCounter }

constructor TPrometheusClientCounter.Create(const MetricName: string; const HelpText: string; const LabelNames: TArray<string>);
begin
...
function TPrometheusClientCounter.GetLabelsString(const Labels: TArray<string>): string;
var
...
procedure TPrometheusClientCounter.Inc(const Labels: TArray<string>; const Value: Double);
var
  Key: string;
  CurrentValue: Double;
begin
...
procedure TPrometheusClientCounter.Inc(const Value: Double);
begin
  Inc([], Value);
end;

function TPrometheusClientCounter.ToMetricsString: string;
var
...
function TPrometheusClientCounter.ToString: string;
begin
